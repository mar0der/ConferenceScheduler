...
class FrontController
{
    ...
    /**
     * @param \My\Mvc\Routers\IRouter $router
     */
    public function setRouter(\My\MVC\Routers\IRouter $router)
    {
        $this->router = $router;
    }
    ...
    {
        $this->config = \My\Mvc\App::getInstance()->getConfig();
    }
    ...
    public function dispatch()
    {
        ...
        $input = \My\Mvc\InputData::getInstance();
