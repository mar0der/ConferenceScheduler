...
namespace My\ShoppingCart\Models;

use My\Mvc\Common;
use My\Mvc\DB\SimpleDB;
use My\Mvc\Validation;
...
class UserModel extends SimpleDB
{
    ...
    public function register(\My\ShoppingCart\Models\BindingModels\User\RegisterUser $model)
    {
        $errors = [];
